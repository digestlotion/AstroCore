...
public class PlanetaryResearchCondition extends RecipeCondition<PlanetaryResearchCondition> {
    ...
    public static final Codec<PlanetaryResearchCondition> CODEC = RecordCodecBuilder.create(instance ->
            isReverse(instance).and(
                    Codec.STRING.fieldOf(RECIPE_DATA_KEY).forGetter(c -> c.planetId)
            ).apply(instance, (reverse, id) -> {
    ...
    public Component getTooltips() {
        return Component.translatable("gtceu.recipe.condition.planetary_research");
    }
